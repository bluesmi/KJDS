...
/**
 *  * 作者：朋来-GZQ on 2017/1/8 13:23
 *  * 邮箱：gongzhiqing@xiyundata.com
 *  
 */
public abstract class CustomerPageTransformer implements ViewPager.PageTransformer {
    ...
    public static CustomerPageTransformer getPageTransformer(TransitionEffect effect) {
        switch (effect) {
            case Default:
